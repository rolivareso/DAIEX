...
<div id="datos-perfil" class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<?php echo $empleado->get_rut_empleado(); ?>
		</div>
	...
	<div class="row">
		...
		<div class="col-md-6">
			<?php echo $empleado->get_nombre_empleado(); ?>
		</div>
		<div class="col-md-3"></div>
	</div><br>
	<div class="row">
		...
		<div class="col-md-3">
			<button type="button" class="btn btn-secondary" onclick="location = 'modificar_empleado.php'"> <i class="fas fa-edit"></i>Editar</a>	
		</div>
	</div><br>
</div>
<!--Footer-->
