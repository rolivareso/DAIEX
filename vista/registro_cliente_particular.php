...
<div class="container-fluid">
	...
	<div class="row">
		<div id="img-registro" class="col-md-6 hidden-sm">
			<img src="../imagenes/img-registro-particular.jpg">
		</div>
		<div id="formulario-registro" class="col-md-12 col-lg-6 text-center">
			<form id="form-registro" action="../controlador/registrar_cliente_particular.php" method="post">
				<h2 class="text-center titulo"><strong>Registro</strong> de cliente</h2>
				<input type="text" name="txt-rut" class="form-control" placeholder="Rut" required><br>
				<input type="text" name="txt-nombre" class="form-control" placeholder="Nombre" required><br>
				<input type="password" name="txt-clave" class="form-control" placeholder="Clave" required><br>
				<input type="email" name="txt-email" class="form-control" placeholder="Email" required><br>
				<input type="tel" name="txt-telefono" class="form-control" placeholder="Teléfono" required><br>
				<input type="text" name="txt-direccion" class="form-control" placeholder="Dirección" required><br>
