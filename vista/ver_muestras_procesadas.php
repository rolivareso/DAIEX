<?php
	...
	$analisisMuestras = $analisisMuestrasbd->leer_analisis_muestras_procesadas_tecnico($usuario->get_rut_usuario());
?>
<!DOCTYPE html>
<html>
<head>
					...
					<?php
						for ($i=0; $i < count($analisisMuestras); $i++) { 
							...
							'<tr>
								...
								<td>
									<a href="ver_detalles_procesadas.php?idMuestra='.$analisisMuestras[$i]->get_id_analisis_muestras().'"">Ver detalles</a>
								</td>
							</tr>';
						}
